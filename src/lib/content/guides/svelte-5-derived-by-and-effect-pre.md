...
Standard `$effect()` runs **after** the DOM has been updated. If you need to read scroll positions or element dimensions *before* the browser repaints, use `$effect.pre()`:
